...
<div class="container">
    ...
    <div class="mt-4">
        <a href="select_seats.php?showtime_id=<?php echo isset($_GET['showtime_id']) ? $_GET['showtime_id']: '';?>&seats=<?php echo isset($_GET['seats']) ? $_GET['seats']: '' ?>"class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Quay lại chọn ghế</a>
    </div>
